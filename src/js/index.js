...
listaSelecaoPokedevs.forEach(pokedev =>{
    pokedev.addEventListener("click", () => {
        ...
        //PASSO 4 - ao clicar em um pokedev da lista pegamos o id desse pokedev pra saber qual cartão abrir
        const idPokedevSelecinado = pokedev.attributes.id.value;
        const idDoCartaoPokedevParaAbrir = "cartao-" + idPokedevSelecinado;
        const cartaoPokedevParaAbri = document.getElementById(idDoCartaoPokedevParaAbrir);
        cartaoPokedevParaAbri.classList.add("aberto");
        ...
        //PASSO 6 - adicinar a classe ativo no pokedev selecionado na listagem
        const pokedevSelecinadoNaListagem = document.getElementById(idPokedevSelecinado);
        pokedevSelecinadoNaListagem.classList.add('ativo');
